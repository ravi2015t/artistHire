...
*/
	...
	public static void main(String[] args) throws Exception {
		...
		try {
			...
			/*
			 * deleteTable(forumTableName); deleteTable(threadTableName);
			...
			createTable(productCatalogTableName, 10L, 5L, "username", "S");
			/*
			 * createTable(forumTableName, 10L, 5L, "Name", "S");
			 * createTable(threadTableName, 10L, 5L, "ForumName", "S",
			 * "Subject", "S"); createTable(replyTableName, 10L, 5L, "Id", "S",
			 * "ReplyDateTime", "S");
			 */
